...
public class EventModel : MVC
{
    ...
    public delegate void InvestigatorTravelEvent(Location l, Investigator i);
    ...
    public event InvestigatorTravelEvent travelEvent;
    ...
    public event ConditionEvent conditionLostEvent; // Asset lost event ?
