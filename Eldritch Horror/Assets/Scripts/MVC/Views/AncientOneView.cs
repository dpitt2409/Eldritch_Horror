...
public class AncientOneView : MVC
{
    ...
    private void SetCultistInfo(Monster c)
    {
        ...
        if (c.tests[0] == TestStat.None)
        {
            ...
            cultistHorror.text = "";
            cultistDamage1Icon.sprite = App.Model.spriteModel.GetTestStatSprite(TestStat.None);
        }
        else
        {
            ...
            cultistDamage1Icon.sprite = App.Model.spriteModel.sanitySprite;
        }
        if (c.tests[1] == TestStat.None)
        {
            ...
            cultistDamage.text = "";
            cultistDamage2Icon.sprite = App.Model.spriteModel.GetTestStatSprite(TestStat.None);
        }
        else
        {
            ...
            cultistDamage2Icon.sprite = App.Model.spriteModel.healthSprite;
        }
