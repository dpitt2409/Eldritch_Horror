...
public class AcquireView : MVC
{
    ...
    public void UpdateAssets()
    {
        ...
        for (int i = 0; i < 4; i++)
        {
            ...
            if (a == null)
            {
                assets[i].GetComponent<Image>().sprite = App.Model.assetSpritesModel.blankIcon;
    ...
    public void InfluenceTested()
    {
        ...
        bool hasDebt = false;
        foreach (Condition c in App.Model.actionPhaseModel.investigators[App.Model.actionPhaseModel.turnIndex].conditions)
        {
