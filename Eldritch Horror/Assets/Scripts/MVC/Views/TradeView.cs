...
public class TradeView : MVC
{
    ...
    private void GeneratePossessionList(Investigator inv, GameObject possessionParent)
    {
        ...
        for (int i = 0; i < inv.shipTickets; i++)
        {
            ...
            st.GetComponent<Image>().sprite = App.Model.spriteModel.shipTicketSprite;
        ...
        {
            GameObject st = Instantiate(possessionButton, possessionParent.transform);
            st.GetComponent<Image>().sprite = App.Model.spriteModel.trainTicketSprite;
        ...
        {
            GameObject st = Instantiate(possessionButton, possessionParent.transform);
            st.GetComponent<Image>().sprite = App.Model.spriteModel.focusTokenSprite;
        ...
        foreach(Clue c in inv.clues)
        {
            ...
            clue.GetComponent<Image>().sprite = App.Model.spriteModel.clueTokenSprite;
